...
describe SmartPaginate::Paginate do
  ...
  describe '#offset' do
    it 'returns 0 when current_page is 1 and per_page is 10' do
      page = SmartPaginate::Paginate.new(1, 10)
