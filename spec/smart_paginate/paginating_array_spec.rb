...
describe SmartPaginate::PaginatingArray do
  ...
  describe '#next_page' do
    ...
    it 'returns the last page when present' do
      users = subject.paginate(per_page: 1, page: 9)
